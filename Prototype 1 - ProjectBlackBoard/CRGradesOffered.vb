...
Public Class CRGradesOffered
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prototype_1___ProjectBlackBoard.CRGradesOffered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRGradesOffered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRGradesOffered = New CRGradesOffered()
        rpt.Site = Me.Site
        Return rpt
    End Function
