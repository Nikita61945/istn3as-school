...
Public Class DetailsGrade
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prototype_1___ProjectBlackBoard.DetailsGrade.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDetailsGrade
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DetailsGrade = New DetailsGrade()
        rpt.Site = Me.Site
        Return rpt
    End Function
