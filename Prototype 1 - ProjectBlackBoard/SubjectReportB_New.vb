...
Public Class SubjectReportB_New
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prototype_1___ProjectBlackBoard.SubjectReportB_New.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ScoresPerSubPerYEar_Grade() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSubjectReportB_New
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubjectReportB_New = New SubjectReportB_New()
        rpt.Site = Me.Site
        Return rpt
    End Function
