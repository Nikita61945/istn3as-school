Public Class CellContent
    Public cellContent As String = CreateExamTimeTable.cellCont
    Public rowIndex As Integer = CreateExamTimeTable.rowIndex
    Public colIndex As Integer = CreateExamTimeTable.rowIndex
    Public panelHeading As String = CreateExamTimeTable.panelHeading
    Public day As String = ""
    Public period As String = ""
    Public grade As Integer = 0
    ...
    Private Sub btnMouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
        ...
        If MessageBox.Show("Are you sure you want to remove " + vbNewLine + vbNewLine + btn.Name.Trim + " ?", "Remove Exam", MessageBoxButtons.YesNo) = DialogResult.Yes Then
            ...
            For i As Integer = 0 To CreateExamTimeTable.panel.Controls.Count - 1
                If (CreateExamTimeTable.panel.Controls.Item(i).Name.ToString = btn.Name.Trim) Then
                    CreateExamTimeTable.panel.Controls.Item(i).Enabled = True
                End If
            Next
    ...
    Private Sub SaveBtn_Click(sender As Object, e As EventArgs) Handles SaveBtn.Click
        If (panel.Controls.Count = 0) Then
            ...
            If MessageBox.Show("You have removed all the exams from the cell. Do you wish to save these changes?", "Cell Update", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                CreateExamTimeTable.ExamTT.Rows(CreateExamTimeTable.rowIndex).Cells(CreateExamTimeTable.colIndex).Value = " "
            End If
            Me.Close()
        Else
