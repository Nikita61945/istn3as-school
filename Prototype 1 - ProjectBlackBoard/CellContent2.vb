Public Class CellContent2
    Public cellContent As String = CreateTimetable.cellCont
    Public rowIndex As Integer = CreateTimeTable.rowIndex
    Public colIndex As Integer = CreateTimetable.rowIndex
    Public panelHeading As String = CreateTimetable.panelHeading
    Public day As String = CreateTimetable.Editday
    Public period As String = CreateTimetable.period
    Public grade As Integer = CreateTimetable.EditGrade
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles CloseName.Click
        ...
        If MessageBox.Show("If you leave now all data will be lost." + vbNewLine + "Do you want to save changes you have made?", "Unsaved Data", MessageBoxButtons.YesNo) = DialogResult.Yes Then
            CreateTimetable.CreateTT.Rows(CreateTimetable.rowIndex).Cells(CreateTimetable.colIndex).Value = cellContent
        End If
        Me.Close()
    End Sub
    ...
    Private Sub SaveBtn_Click(sender As Object, e As EventArgs) Handles SaveBtn.Click
        If (panel.Controls.Count = 0) Then
            ...
            If MessageBox.Show("You have removed all the exams from the cell. Do you wish to save these changes?", "Cell Update", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                CreateTimetable.CreateTT.Rows(CreateTimetable.rowIndex).Cells(CreateTimetable.colIndex).Value = " "
            End If
            Me.Close()
        Else
