...
Public Class SubjectReportB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Prototype_1___ProjectBlackBoard.SubjectReportB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubjectReportB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubjectReportB = New SubjectReportB()
        rpt.Site = Me.Site
        Return rpt
    End Function
